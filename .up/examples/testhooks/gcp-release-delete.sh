...
${KUBECTL} annotate xservices.gcp.caas.upbound.io --all crossplane.io/paused="true" --overwrite=true
${KUBECTL} delete release -l crossplane.io/claim-name=gcp-spoke-02
