...
${KUBECTL} annotate xservices.azure.caas.upbound.io --all crossplane.io/paused="true" --overwrite=true
${KUBECTL} delete release -l crossplane.io/claim-name=azure-spoke-02
